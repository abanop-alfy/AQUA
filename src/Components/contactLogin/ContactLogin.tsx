...
export default function ContactLogin() {
  ...
  return <div>
    ...
    <a className="et-hero-tab" href="/">
        ...
        <Hidden smDown>
      <a className="et-hero-tab" href="#tab-es6">FaceBook<FacebookIcon/></a>
      <a className="et-hero-tab" href="#tab-flexbox">Email<MailIcon/></a>
      <a className="et-hero-tab" href="#tab-react">WhatsApp<WhatsAppIcon/></a>
      <a className="et-hero-tab" href="#tab-angular">LinkedIN<LinkedInIcon/></a>
